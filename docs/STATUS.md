...
Review the Phase 3 route-refinement and spacing slice in staging, then address STG-001 for the contact workflow before any further production promotion. Future guide changes must be versioned as v1.1 or v2.0 and approved before production promotion. Do not connect a CMS or backend until the public visual system is approved.
