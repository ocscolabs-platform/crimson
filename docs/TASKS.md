...
- **Status:** In progress — form UI and Supabase submission in staging; production delivery workflow pending
...
- The staging form submits validated inquiries to `public.inquiries`; owner notification and the production delivery method remain pending approval.
