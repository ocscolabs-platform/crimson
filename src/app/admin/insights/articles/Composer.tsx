...
export default function InsightsComposer({ taxonomy, role, canPublishInsights, article }: ComposerProps) {
  ...
  const [categoryDeleteState, setCategoryDeleteState] = useState(initialCategoryState);
