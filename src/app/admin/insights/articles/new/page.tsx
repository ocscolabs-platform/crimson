  ...
  return (
    <main className="admin-page">
      <div className="admin-shell admin-editor-shell">
        ...
        <div className="admin-editor-panel"><p className="admin-editor-warning">Title is required for the first save. Add a Cover with meaningful alternative text before Submit or Publish; the slug is generated server-side and can be adjusted later under Advanced.</p><InsightsComposer taxonomy={taxonomy} role={membership.role === "owner" ? "owner" : "editor"} canPublishInsights={membership.canPublishInsights} /></div>
        <footer className="admin-footer">Drafts are private. Autosave, Preview, media, and public Insights remain governed by the current workflow boundaries.</footer>
      </div>
    </main>
  );
}
