  ...
  return (
    <main className="admin-page">
      <div className="admin-shell admin-editor-shell">
        ...
        <div className="admin-editor-panel"><p className="admin-editor-warning">This is a writing-first Draft. Title is required for the first save; the slug is generated server-side and can be adjusted later under Advanced.</p><InsightsComposer taxonomy={taxonomy} role={membership.role === "owner" ? "owner" : "editor"} canPublishInsights={membership.canPublishInsights} /></div>
