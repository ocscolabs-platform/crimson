  ...
  return (
    <main className="admin-page">
      <div className="admin-shell admin-editor-shell">
        ...
        <section className="insights-guidance" aria-label="Draft guidance"><div><p className="admin-kicker admin-kicker-green">B6B3 workflow</p><h2>Write → Review → Publish.</h2></div><p>Draft autosave, private media, authenticated Preview, and the protected publication boundary keep the editorial loop explicit. Public Insights remain limited to the exact Published revision.</p></section>
