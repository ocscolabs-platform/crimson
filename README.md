...
The staging branch also contains a protected CMS dashboard at `/admin`, a controlled service editor at `/admin/services/[slug]`, and database-generated audit history. It uses Supabase Auth sessions and RLS-backed role boundaries; staging setup, publishing limits, audit safeguards, and the case-study design gate are described in [`docs/PHASE-4-CMS-AUTH.md`](./docs/PHASE-4-CMS-AUTH.md), [`docs/PHASE-4-CMS-EDITOR.md`](./docs/PHASE-4-CMS-EDITOR.md), [`docs/PHASE-4-CMS-AUDIT.md`](./docs/PHASE-4-CMS-AUDIT.md), and [`docs/PHASE-4-CMS-CASE-STUDIES.md`](./docs/PHASE-4-CMS-CASE-STUDIES.md). Broader CMS editing and Production publishing are intentionally not enabled.
