...
test("Security hardening remains migration #29 and current staging migrations remain additive", async () => {
  ...
  assert.equal(files.at(-3), "20260828000000_add_phase6b3_insights_media_workflow.sql");
